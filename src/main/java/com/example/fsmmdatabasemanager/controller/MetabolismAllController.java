...
public class MetabolismAllController {
    ...
    @GetMapping("")
    @ResponseBody
    public ModelAndView MetabolismAllIndex(@RequestParam(defaultValue = "1", required = false)int pageNum, @RequestParam(defaultValue = "50", required = false)int perPageNum){
