;(function($){
	$(document).ready(function(){
        ...
        //more templates��http://www.bootstrapmb.com
    ...
    var taskTemplate = '<li class="task group"><div class="task-container hover:bg-[#EBEEEF] listStyle cursor-pointer table bg-white px-[15px] py-2 w-full border border-[#eaeaes] relative transition-all ease-in-out duration-[0.2s]"><span class="table-cell align-middle w-10 text-left task-action-btn task-check"><span class="w-6 h-6 bg-white border border-btnBorder rounded-full inline-block text-center transition-all ease-in-out duration-[0.2s] action-circle large complete-btn" title="Mark Complete"><i class="material-icons text-base text-[#cccccc]">check</i></span></span><span class="task-label table-cell align-middle text-[#333333] break-all" contenteditable="true">Patient Profile add</span><span class="hidden task-action-btn task-btn-right group-hover:block text-right"><span class="w-6 h-6 bg-white border border-btnBorder rounded-full inline-block text-center action-circle transition-all ease-in-out duration-[0.2s] action-circle large" title="Assign"><i class="material-icons text-base text-[#cccccc]">person_add</i></span><span class="w-6 h-6 bg-white border border-btnBorder rounded-full inline-block text-center action-circle transition-all ease-in-out duration-[0.2s] action-circle large delete-btn" title="Delete Task"><i class="material-icons text-base text-[#cccccc]">delete</i></span></span></div></li>';
